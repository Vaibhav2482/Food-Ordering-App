...
export const getActiveTables = asyncHandler(async (req, res) => {
    ...
    const result = await TableService.getActiveTables(resolveBranchId(req));
...
export const getAllTables = asyncHandler(async (req, res) => {
    ...
    const result = await TableService.getAllTables(resolveBranchId(req));
...
export const deactivateTable = asyncHandler(async (req, res) => {
    ...
    const result = await TableService.deactivateTable(id);
